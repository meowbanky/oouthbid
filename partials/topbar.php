...
<header class="app-header flex items-center px-4 gap-3">
    ...
    <div class="relative md:flex hidden">
        ...
        <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-500 w-80 z-50 mt-2 transition-[margin,opacity] duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg">
...
<!--            </a>-->
    ...
    <div class="relative">
        ...
        <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-500 w-44 z-50 transition-[margin,opacity] duration-300 mt-2 bg-white shadow-lg border rounded-lg p-2 border-gray-200 dark:border-gray-700 dark:bg-gray-800">
...
<div>
    <div id="topbar-search-modal" class="fc-modal hidden w-full h-full fixed top-0 start-0 z-50">
        <div class="fc-modal-open:opacity-100 fc-modal-open:duration-500 opacity-500 transition-all sm:max-w-lg sm:w-full m-12 sm:mx-auto">
