...
mysqli_select_db($pos,$database_pos);
$Result1 = mysqli_query($pos,$UpdateSalesQty) or die(mysqli_error($pos));
...
<div id="register_container" class="sales clearfix">
	...
	<h1 class="headigs"> <i class="icon fa fa-shopping-cart"></i>
		Company Name - &nbsp; <?php echo $_SESSION['SESS_INVOICE'] ?><span id="ajax-loader" style="display: none;"><img src="./sales_files/ajax-loader.gif" alt=""></span>
			</h1>
