...
<div id="register_container" class="sales clearfix">
	...
	<h1 class="headigs"> <i class="icon fa fa-shopping-cart"></i><?php echo $_SESSION['SESS_INVOICE'] ?><span id="ajax-loader" style="display: none;"><img src="img/ajax-loader.gif" alt=""></span>
			</h1>
